...
/* Compares the priorities of two threads. Returns true if 
   the first thread has a higher priority than the second. */
               ...
               thread_func *function, void *aux) 
{
  ...
  // checking the new thread priority and current thread priority
